...
public class PageSubscriptionCounterImpl implements PageSubscriptionCounter
{
   ...
   protected void cleanup()
   {
      ...
      try
      {
         ...
         if (isTrace)
         {
            log.trace("Replacing page-counter record = "  + recordID + " by record = " + newRecordID + " on subscriptionID = " + this.subscriptionID + " for queue = " + (this.subscription.getQueue() != null ? this.subscription.getQueue().getName() : "not set"));
         }
